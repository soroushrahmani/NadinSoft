          ...
          <div class="flex flex-col items-center justify-center min-h-screen text-gray-700 p-10 bg-custom-gray dark:bg-gray-800">
              <form class="max-w-sm mx-auto">
                  ...
                  <div class="mb-5">
                      ...
                      <input     @keypress.enter="save" type="text" v-model="lastName" id="text" class="bg-custom-gray border border-custom-border text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                  </div>
